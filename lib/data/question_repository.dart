...
class QuestionRepository {
  ...
  // World 1 - Level 5: Single-Digit Mixed Arithmetic (Boss Level)
  static const List<QuestionModel> world1Level5Questions = [
    QuestionModel(
      id: 'w1_l5_q1',
      topic: 'Mixed Arithmetic',
      difficulty: 'Beginner',
      questionText: 'What is 5 + 4 - 3?',
      options: ['5', '6', '7', '8'],
      correctAnswerIndex: 1,
      explanationSteps: [
      ...
      hintText: 'First add 5 + 4 = 9, then take away 3.',
      xpReward: 35,
      coinReward: 15,
      gemReward: 2,
    ),
    QuestionModel(
      ...
      hintText: 'Multiply 3 × 4 first, then add 2.',
      xpReward: 35,
      coinReward: 15,
      gemReward: 2,
    ),
    QuestionModel(
      ...
      hintText: 'Divide 12 by 3 to get 4, then add 5.',
      xpReward: 35,
      coinReward: 15,
      gemReward: 2,
    ),
    QuestionModel(
      ...
      topic: 'Mixed Arithmetic',
      difficulty: 'Beginner',
      questionText: 'What is 8 × 2 - 5?',
      options: ['9', '11', '13', '15'],
      correctAnswerIndex: 1,
      explanationSteps: [
        'Multiply first: 8 × 2 = 16',
        'Then subtract: 16 - 5 = 11',
        'Therefore, 8 × 2 - 5 = 11!'
      ],
      hintText: '8 × 2 = 16. Subtract 5.',
      xpReward: 40,
      coinReward: 20,
      gemReward: 2,
    ),
    QuestionModel(
      ...
      hintText: 'Multiply 3 × 3 first (9), then subtract from 15.',
      xpReward: 50,
      coinReward: 25,
      gemReward: 3,
    ),
