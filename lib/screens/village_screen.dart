...
class VillageScreen extends StatelessWidget {
                ...
                SliverToBoxAdapter(
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: GameColors.sunnyYellow.withValues(alpha: 0.18),
                        borderRadius: BorderRadius.circular(16),
                        border: Border.all(
                      ...
                      child: Row(
                        children: [
                          Image.asset('assets/images/wood_log.png', height: 26),
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: building.currentStage > 0
              ? GameColors.turquoise.withValues(alpha: 0.5)
  ...
  Color _getStageBgColor(int stage) {
    switch (stage) {
      case 0:
        return GameColors.cardBorder.withValues(alpha: 0.3);
      case 1:
        return GameColors.streakOrange.withValues(alpha: 0.15);
      case 2:
        return GameColors.skyBlue.withValues(alpha: 0.15);
      case 3:
      default:
        return GameColors.freshGreen.withValues(alpha: 0.15);
    }
  }
